...
import { cardsCommand, helpCommand, pingCommand, rulesCommand, statsCommand } from './features';
...
const bootstrap = async () => {
	try {
		...
		await client.putCommands([pingCommand, helpCommand, rulesCommand, cardsCommand, statsCommand]);
		sql.syncModels([User]);
