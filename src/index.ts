...
import { cardsCommand, helpCommand, pingCommand, rulesCommand, statsCommand, topCommand } from './features';
...
const bootstrap = async () => {
	try {
		...
		await client.putCommands([pingCommand, helpCommand, rulesCommand, cardsCommand, statsCommand, topCommand]);
		sql.syncModels([User]);
